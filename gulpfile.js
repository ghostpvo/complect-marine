...
SRC_DIR.lessBlocks = SRC_DIR.root + 'blocks/';
SRC_DIR.pug = SRC_DIR.root + 'pug/';
SRC_DIR.pugBlocks = SRC_DIR.root + 'blocks/';

// Source file matchers, using respective directories
const SRC_FILES = {
	less: SRC_DIR.less + '**/*.less',
  lessBlocks: SRC_DIR.lessBlocks + '**/*.less',
	pug: SRC_DIR.pug + '**/*.pug',
  pugBlocks: SRC_DIR.pugBlocks + '**/*.pug',
	js: SRC_DIR.js + '**/*.js',
	images: SRC_DIR.img + '**/*',
...
gulp.task('watch', () => {
	gulp.watch([SRC_FILES.less,  SRC_FILES.lessBlocks], ['less']);
	gulp.watch([SRC_FILES.pug,  SRC_FILES.pugBlocks], ['pug']);
